...
const switchButton = document.querySelector('[data-js="switch-inputs"]');
...
switchButton.addEventListener("click", () => {
  const originalFirst = firstInput.value;
  const originalSecond = secondInput.value;
  (firstInput.value = originalSecond), (secondInput.value = originalFirst);
});
